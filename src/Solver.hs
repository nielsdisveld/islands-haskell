...
processLine :: Count -> Marker -> PairedLine -> (Count, Marker, Line Int)
...
mark :: Marker -> IslandState -> PairedLine -> Line Int
...
markBy :: Marker -> PairedLine -> Line Int
